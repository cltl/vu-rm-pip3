...
function install-mor {
  ...
  $scriptdir/install-alpino.sh https://www.let.rug.nl/vannoord/alp/Alpino/versions/binary/Alpino-x86_64-Linux-glibc-2.17-git819-sicstus.tar.gz $resourcesdir/Alpino
